...
export function useAutomations() {
  return useQuery({ queryKey: AUTOMATIONS_KEY, queryFn: () => listAutomations(), staleTime: 30_000 })
}

export function useRetentionStats() {
  return useQuery({ queryKey: RETENTION_STATS_KEY, queryFn: () => getRetentionStats(), staleTime: 60_000 })
}
